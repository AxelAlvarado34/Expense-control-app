            ...
            >
                <div className='form-camp'>
                    <div className='form-block'>
                        <label htmlFor="expenseName" className='form-expense-label'>Expense name:</label>
                        <input
                            type="text"
                            id='expenseName'
                            name='expenseName'
                ...
                <div className='form-camp'>
                    <div className='form-block'>
                        <label htmlFor="category" className='form-expense-label'>Expense name:</label>
                        <select
                            name="category"
                            id="category"
                            ...
                            onChange={handleChange}
                        >
                            <option value="" className='category-opt'>Select option</option>
                            {
                    ...
                    <div className='form-block'>
                        <label htmlFor="date" className='form-expense-label'>Date:</label>
                        <input
                            type="date"
                            id='date'
                            name='date'
